// ../component/medication_hero_setion.tsx
...
export function AnalysisHero({ streak, todayStatus, monthlyRate }: AnalysisHeroProps) {
  return (
      ...
      <div className="bg-gradient-to-r from-[#3b82f6] via-[#2dd4bf] to-[#22c55e] rounded-[2rem] p-8 text-white shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-[1.5rem] p-6 border border-white/10 flex flex-col justify-between">
            <div className={`w-6 h-6 rounded-full border-2 mb-2 transition-colors ${
              todayStatus === 'taken' ? 'bg-white border-white' : 
              todayStatus === 'missed' ? 'bg-red-400 border-red-400' : 'border-white/50'
            }`} />
          ...
          {/* Monthly Rate */}
          <div className="bg-white/10 backdrop-blur-md rounded-[1.5rem] p-6 border border-white/10">
            <div className="text-4xl font-bold mb-1">{monthlyRate}%</div>
